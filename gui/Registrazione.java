...
public class Registrazione extends JFrame {
    ...
    private final JComboBox<String> ruoloBox = new JComboBox<>(
    ...
    private void initUI() {
        ...
        gbc.gridx=1;
        ruoloBox.setPreferredSize(new Dimension(240,36)); ruoloBox.setFont(new Font("Segoe UI", Font.PLAIN,16));
        formPanel.add(ruoloBox,gbc);
    ...
    private void onRegister() {
        ...
        String ruolo = (String) ruoloBox.getSelectedItem();
